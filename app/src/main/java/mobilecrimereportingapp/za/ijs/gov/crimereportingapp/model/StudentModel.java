...
public class StudentModel {
    ...
    public StudentModel(String fullName){
        this.FullName = fullName;
    }

    public StudentModel(String Email, String Password, String PhoneNumber, String FullName, String Province, String Area, GradeModel Grade, List<SubjectModel> Subjects, List<String> Tutors, String PreferredTutoringMethod) {
        this.Email = Email;
